...
urlpatterns = [
    ...
    path('admin-panel/create-election/', TemplateView.as_view(template_name='create_election.html'), name='create_election'),
    path('admin-panel/add-voter/', TemplateView.as_view(template_name='add_voter.html'), name='add_voter'),
    path('admin-panel/preview-user/', TemplateView.as_view(template_name='preview_user.html'), name='preview_user'),
